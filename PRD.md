...
## GasPilot — Trade Business Management App
...
### 1.1 Purpose
GasPilot is a mobile-first business management application built for tradespeople and their teams. It provides a unified platform to manage jobs, customers, workers, invoices, quotes, and gas safety certificates — replacing paper-based and fragmented workflows with a single tool.
...
### 1.3 Solution
GasPilot consolidates all trade business operations into one mobile app with:
...
*GasPilot PRD v1.0 — Confidential*
