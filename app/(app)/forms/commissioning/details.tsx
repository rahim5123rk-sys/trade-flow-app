...
function FgaGroup({
  ...
  onChange: (value: {co: string; co2: string; ratio: string}) => void;
}) {
  return (
    <View style={styles.fgaGroup}>
      ...
      <View style={styles.row}>
        <View style={{flex: 1}}>
          <Input label="CO (ppm)" value={value.co} onChangeText={(next) => onChange({...value, co: next})} keyboardType="decimal-pad" placeholder="0.0" />
        </View>
        <View style={{flex: 1}}>
          <Input label="CO₂ (%)" value={value.co2} onChangeText={(next) => onChange({...value, co2: next})} keyboardType="decimal-pad" placeholder="0.0" />
        </View>
        <View style={{flex: 1}}>
          <Input label="Ratio" value={value.ratio} onChangeText={(next) => onChange({...value, ratio: next})} keyboardType="decimal-pad" placeholder="0.000" />
        </View>
      </View>
    </View>
  );
      ...
      <KeyboardAvoidingView style={{flex: 1}} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        >
          ...
          <FormSection title="Readings & Analysis">
            ...
            <FgaGroup label="Low fire" value={form.fgaLow} onChange={(value) => updateField('fgaLow', value)} />
            <FgaGroup label="High fire" value={form.fgaHigh} onChange={(value) => updateField('fgaHigh', value)} />
          </FormSection>
