...
export default function ServiceRecordIndex() {
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top + 20 }]}>
      ...
      <Ionicons name="construct" size={64} color="#059669" style={{ marginBottom: 16 }} />
      <Text style={[styles.title, { color: theme.text.title }]}>Service Record</Text>
