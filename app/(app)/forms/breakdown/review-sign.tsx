...
export default function BreakdownReviewSignScreen() {
  ...
  const {customerForm, propertyAddress, propertyAddressLine1, propertyAddressLine2, propertyCity, propertyPostCode, appliances, finalInfo, reportDate, setReportDate, customerSignature, setCustomerSignature, certRef, setCertRef, resetBreakdownReport, editingDocumentId} = useBreakdownReport();
  ...
  const pdfData: BreakdownReportPdfData = {customerName: customerForm.customerName || '', customerCompany: customerForm.customerCompany || '', customerAddress, customerEmail: customerForm.email || '', customerPhone: customerForm.phone || '', propertyAddress, appliances, finalInfo, reportDate, customerSignature, certRef};
