...
• Supabase (Database, Authentication & File Storage): Your data is stored securely in Supabase's cloud infrastructure. This includes structured records in the database, user authentication, and object storage for generated certificate PDF files. Supabase acts as our data processor under a Data Processing Agreement.
...
• Certificate PDF files generated by the View Certificate feature are stored in Supabase file storage as part of your certificate archive and are subject to the same retention period as the underlying certificate record. Time-limited viewing links (valid for 1 hour) are generated on demand and expire automatically.`,
  },
  {
...
• Row-level security policies are enforced at the database level and on file storage.
• Certificate PDF files in cloud storage are scoped to your company and cannot be accessed by other companies. Viewing links are time-limited (1 hour) and require an authenticated session to generate.`,
  },
  {
