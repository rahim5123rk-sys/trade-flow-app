...
• upload malicious code, harmful content or material you have no right to use.`,
  ...
  },
  {
    ...
    body: `GasPilot may support forms and records including, for example, CP12 / Landlord Gas Safety Records, service records, warning notices, commissioning records, decommissioning records, breakdown reports, installation certificates, invoices, quotes and related job documentation.
